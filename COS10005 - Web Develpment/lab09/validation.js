...
function validate() {
	...
	if (!pwd1.match(pwdPattern2)) {
		errMsg += "Password must contain at least 1 uppercase.\n";
	}
	if (!pwd1.match(pwdPattern3)) {
		errMsg += "Password must contain at least 1 lowercase.\n";
	}
